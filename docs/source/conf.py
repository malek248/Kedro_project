...
# financial_predictions documentation build
...
from financial_predictions import __version__ as release

# -- Project information -----------------------------------------------------

project = "financial_predictions"
author = "Kedro"
...
htmlhelp_basename = "financial_predictionsdoc"
...
latex_documents = [
    (
        master_doc,
        "financial_predictions.tex",
        "financial_predictions Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "financial_predictions",
        "Project financial_predictions codebase.",
        "Data-Science",
    )
]
